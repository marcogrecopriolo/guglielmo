...
motObject::motObject(RadioInterface *mr, bool dirElement, uint16_t transportId,
...
uint16_t motObject::get_transportId() { return transportId; }
...
int motObject::get_headerSize() { return headerSize; }
